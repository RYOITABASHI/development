...
function DeviceResponsiveUI() {
    return (react_1.default.createElement("div", { className: "conductor-layout pc" },
        react_1.default.createElement("div", { className: "conductor-left" },
            ...
            react_1.default.createElement("div", { className: "conductor-body" },
                react_1.default.createElement("div", { className: "conductor-message" }, "assistant: Hello! PC optimized Conductor."),
...
exports.default = DeviceResponsiveUI;
